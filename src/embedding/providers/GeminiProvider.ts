...
export class GeminiProvider extends BaseEmbeddingProvider {
  private static readonly DEFAULT_BASE_URL = 'https://generativelanguage.googleapis.com';
  ...
  async testConnection(): Promise<boolean> {
    try {
      ...
      logger.error('Gemini connection test failed:', error as Error);
      return false;
    }
  }
  ...
  async getModelInfo(): Promise<any> {
    try {
      ...
      logger.error('Failed to get Gemini model info:', error as Error);
      return null;
    }
  }
}
